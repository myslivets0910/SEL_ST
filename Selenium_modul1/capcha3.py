...
try:
    ...
    browser.execute_script("return arguments[0].scrollIntoView(true);", Rule2)
    # скролим в поле зрения элемента Rule2
    Rule2.click() # кликаем на радиокнопку
    submit1 =browser.find_element(By.XPATH, '/html/body/div[1]/form/button')
    # ищем кнопку
