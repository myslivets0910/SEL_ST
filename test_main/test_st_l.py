...
class TestAliens:
    def test_aliens_task(self, browser, links):
        ...
        input_email = browser.find_element(By.XPATH, '//*[@id="id_login_email"]')  # вводим логин
        input_email.send_keys("твой email")

        input_password = browser.find_element(By.XPATH, '//*[@id="id_login_password"]')
        input_password.send_keys("твой пароль")  # вводим пароль
        ...
        try:
            ...
            assert answer_feedback.text == "Correct!"